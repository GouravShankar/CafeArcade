                        ...
                        <div class="backside">
                            <div class="card">
                                <div class="card-body text-center mt-4">
                                    <h4 class="card-title">{{ $row->product_name }}</h4>
                                    <p class="card-text">Café Arcade is a must-visit for coffee lovers. Their expertly crafted brews, 
                                        from bold espressos to smooth cappuccinos, offer a rich, full-bodied flavor in every sip. 
                                        The cozy ambiance and friendly baristas create a perfect spot to relax or work. 
                                        Whether you're a casual drinker or a coffee enthusiast, Café Arcade delivers an 
                                        outstanding experience with every cup.</p>
